...
const myVideogames = videogames.filter(function (videogame){
    return videogame.genders === 'RPG'; 
});
const reduceTotal = videogames.reduce(function(accumulador, videogames){
    return accumulador + videogames.score;}, 0);
let media = reduceTotal / 4;
console.log(media);

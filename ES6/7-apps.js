...
const totalSuma = exams.reduce(function(accumulador, exams){
    return accumulador + exams.score;}, 0);
...
const sumaAproved = exams.reduce(function(accumulador, exams){
    if(exams.score <= 5){
    return accumulador + exams.score};
    console.log(exams);
})

//7.3 Dado el mismo array, haz la media de las notas de todos los examenes .reduce().
const total = exams.reduce(function(accumulador, exams){
        return accumulador + exams.score;}, 0);
    let media = total / 10;
console.log(media);